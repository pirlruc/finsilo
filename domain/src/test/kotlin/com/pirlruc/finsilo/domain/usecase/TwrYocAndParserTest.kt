...
class TwrYocAndParserTest {
    ...
    fun parsersReadFreeApiPayloads() {
        ...
        val overview = """{"AnalystRatingStrongBuy":"8","AnalystRatingBuy":"2","AnalystRatingHold":"0","AnalystRatingSell":"0","AnalystRatingStrongSell":"0"}"""
        ...
        val wti = """{"name":"WTI","interval":"daily","data":[{"date":"2026-08-14","value":"77.10"},{"date":"2026-08-15","value":"78.50"}]}"""
    ...
    private fun cashTx(id: String, date: LocalDate, amount: BigDecimal) =
        Transaction(id, cash.id, date, TransactionType.DEPOSIT_CASH, amount, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ZERO)

    private fun buy(id: String, assetId: String, date: LocalDate, qty: BigDecimal, price: BigDecimal) =
        Transaction(id, assetId, date, TransactionType.BUY, qty, price, BigDecimal.ONE, price, BigDecimal.ZERO)

    private fun dividend(id: String, date: LocalDate) =
        Transaction(id, stock.id, date, TransactionType.DIVIDEND, bd("10"), bd("1"), BigDecimal.ONE, bd("1"), BigDecimal.ZERO)
}
